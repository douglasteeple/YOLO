...
#ifdef OPENCV
    cvWaitKey(5000);    // milliseconds for a key press, else return
#endif
}
...
int main(int argc, char **argv)
{
    ...
    if (argc < 2 || (argc==2&&(!strcmp(argv[1],"-h")||!strcmp(argv[1],"--help")))) {
        fprintf(stderr, "usage: %s <function> <config file> <weights file> [-i<n>|-nogpu] [<input>]\n", argv[0]);
        fprintf(stderr, "where 'function' is one of:\n");
        fprintf(stderr, "\tart: ...\n");
        fprintf(stderr, "\taverage: ...\n");
        fprintf(stderr, "\tcoco: ...\n");
        fprintf(stderr, "\tdetector [test|demo] ...\n");
        fprintf(stderr, "\tdetect: [-thresh, -out, -fullscreen]\n");
        fprintf(stderr, "\tyolo: [train/test/valid/demo]  [-prefix,-thresh,-c,-s]\n");
        fprintf(stderr, "\tvoxel: ...\n");
        fprintf(stderr, "\tcifar: ...\n");
        fprintf(stderr, "\tgo: go game\n");
        fprintf(stderr, "\trnn: reverse neural network\n");
        fprintf(stderr, "\tclassify: ...\n");
        fprintf(stderr, "\tclassifier: ...\n");
        fprintf(stderr, "\tregressor: ...\n");
        fprintf(stderr, "\tsegmenter: ...\n");
        fprintf(stderr, "\ttag: ...\n");
        ...
        fprintf(stderr, "\t3d: ...\n");
        fprintf(stderr, "\ttest: ...\n");
        fprintf(stderr, "\tcaptcha: ...\n");
        fprintf(stderr, "\tnightmare: \n");
        fprintf(stderr, "\t\t-rounds n: change the number of rounds (default 1). More rounds means more images generated and usually more change to the original image.\n\
        ...
        ");
        fprintf(stderr, "\trgbgr: ...\n");
        fprintf(stderr, "\treset: ...\n");
        fprintf(stderr, "\tdenormalize: ...\n");
        fprintf(stderr, "\tstatistics: ...\n");
        fprintf(stderr, "\tnormalize: ...\n");
        fprintf(stderr, "\trescale: ...\n");
        fprintf(stderr, "\tops: ...\n");
        fprintf(stderr, "\tspeed: ...\n");
        fprintf(stderr, "\toneoff: ...\n");
        fprintf(stderr, "\toneoff2: ...\n");
        fprintf(stderr, "\tpartial: ...\n");
        fprintf(stderr, "\taverage: ...\n");
        fprintf(stderr, "\tvisualize: ...\n");
        fprintf(stderr, "\tmkimg: ...\n");
        fprintf(stderr, "\timtest: ...\n");
        return 0;
    }
